class AppointmentCalendar {
            ...
            eventDidMount: (info) => {
                ...
                if (event.extendedProps.isHoliday) {
                    ...
                    tooltip = `Patient: ${event.extendedProps.username || 'N/A'}
                        Service: ${event.extendedProps.service_type || 'N/A'}
    ...
    openAppointmentModal(event) {
        ...
        if (status) status.value = event.extendedProps.status;
        ...
        <div class="mb-3">
            ...
            <p><strong>Service:</strong> ${event.extendedProps.service_type || 'N/A'}</p>
            <p><strong>Date:</strong> ${this.formatDate(event.start)}</p>
